...
public class ImageUtil {
    ...
    public static void main(String[] args) {
        String path = "F:/k210/k210-web/public";
        String base64 = ImageUtil.convertImageToBase64Str(path+"/2024/02/17/a5a35922-be7c-474d-a9bf-6a7ae6402be3.jpg");
        System.out.println(base64);
        String downPath = "F:/k210/imags/new.jpg";
        ImageUtil.convertBase64StrToImage(base64,downPath);
    }
